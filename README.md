...
<br>None of these are random, and you most definitely wouldn't any nuclear codes or winning lottery numbers in these sequences. If we want to discuss the validity of the quote's claims, we need to find a more robust method of determining its randomness. <br><br>
Firstly, $\pi$ can't be random. It has fixed, determined digits, and we are able to calculate every single one. It makes more sense to ask whether $\pi$ is a [normal number](https://en.wikipedia.org/wiki/Normal_number), which roughly means every sequence of digits of the same length has equal density. If $\pi$ is indeed a normal number, then the quote above is accurate due to the [infinite monkey theorem](https://en.wikipedia.org/wiki/Infinite_monkey_theorem#:~:text=The%20infinite%20monkey%20theorem%20states,an%20infinite%20number%20of%20times).<br>
### Setup:
...
## Test 1: Frequency
First, check if the frequency of each digit is roughly equal in the first million digits.
| Figure 1                                                                                                           | Analysis                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
...
## Test 2: Pairs
Next, check if each digit is followed by every other digit with equal probability.
| Figure 2                                                                                                           | Analysis                                                                                                                        |
| ------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------- |
...
## Test 3: Spaces
Finally, check the distance between each recurrence of each digit is around 10.
| Figure 3                                                                                                           | Analysis                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
### Conclusion:
These tests do not, in any sense, prove the random distribution of the digits of $\pi$. Pi's digits, however, seem to pass most modern tests for assessing randomness in sequences. Our methods are too inconclusive to determine the quote's validity, but also are too inconclusive to decisively invalidate the original author's inspiration.
